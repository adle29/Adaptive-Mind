d3 = function() {
    ...
    function A(n) {
        return arguments.length || (n = Zo.ascending),
        function(t, e) {
    ...
    function D() {
        var n = ".dragsuppress-" + ++Ma,
            ...
            r = "dragstart" + n,
            u = "click" + n,
            i = Zo.select(Wo).on(t, f).on(e, f).on(r, f),
            o = Bo.style,
            a = o[xa];
        return o[xa] = "none",
        function(t) {
    ...
    function ft(n, t, e) {
        ...
        var r = et((.4124564 * n + .3575761 * t + .1804375 * e) / ja),
            u = et((.2126729 * n + .7151522 * t + .072175 * e) / Ha),
            i = et((.0193339 * n + .119192 * t + .9503041 * e) / Fa);
        ...
        function e(n) {
            ...
            return {
                ...
                point: function(f, h) {
                    ...
                    if (!e && (s = c = v) && n.lineStart(), v !== c && (g = r(e, p), (jt(e, g) || jt(p, g)) && (p[0] += ka, p[1] += ka, v = t(p[0], p[1]))), v !== c) l = 0, v ? (n.lineStart(), g = r(p, e), n.point(g[0], g[1])) : (g = r(e, p), n.point(g[0], g[1]), n.lineEnd()), e = g;
                    else if (a && e && o ^ v) {
                        var m;
        ...
        function e(t, i, o, a, c, s, l, f, h, g, p, v, d, m) {
            ...
            if (M > 4 * r && d--) {
                var _ = a + g,
                    ...
                    k = Math.asin(w /= S),
                    E = ua(ua(w) - 1) < ka ? (o + h) / 2 : Math.atan2(b, _),
                    A = n(E, k),
                    C = A[0],
                    N = A[1],
                    L = C - t,
    ...
    function rr(n) {
        for (var t, e, r, u, i, o, a, c, s, l, f = n[0][0], h = n[1][0], g = n[0][1], p = n[1][1], v = Ic, d = v.length; d--;)
            if (i = v[d], i && i.prepare())
                for (a = i.edges, c = a.length, o = 0; c > o;) l = a[o].end(), r = l.x, u = l.y, s = a[++o % c].start(), t = s.x, e = s.y, (ua(r - t) > ka || ua(u - e) > ka) && (a.splice(o, 0, new pr(hr(i.site, l, ua(r - f) < ka && p - u > ka ? {
                    x: f,
                    y: ua(t - f) < ka ? e : p
                } : ua(u - p) < ka && h - r > ka ? {
                    x: ua(e - p) < ka ? t : h,
    ...
    function Mr(n, t) {
        ...
        for (Yc = [], Ic = new Array(n.length), Zc = new vr, Xc = new vr;;)
            if (u = Vc, i && (!u || i.y < u.y || i.y === u.y && i.x < u.x))(i.x !== e || i.y !== r) && (Ic[i.i] = new er(i), Qe(i), e = i.x, r = i.y), i = n.pop();
            else {
                if (!u) break;
                Ke(u.arc)
            }
    ...
    function Lr(n, t) {
        var e, r, u, i, o, a = 0,
            ...
            s = [],
            l = [];
        for (n += "", t += "", Jc.lastIndex = 0, r = 0; e = Jc.exec(t); ++r) e.index && s.push(t.substring(a, c = e.index)), l.push({
            i: s.length,
            x: e[0]
        }), s.push(null), a = Jc.lastIndex;
    ...
    function lu(n, t, e) {
        ...
        if (n.charge = 0, !n.leaf)
            for (var i, o = n.nodes, a = o.length, c = -1; ++c < a;) i = o[c], null != i && (lu(i, t, e), n.charge += i.charge, r += i.charge * i.cx, u += i.charge * i.cy);
        if (n.point) {
    ...
    function Lu(n, t) {
        var e = n.children;
        if (e && (u = e.length))
            for (var r, u, i = -1; ++i < u;) t(r = Lu(e[i], t), n) > 0 && (n = r);
        return n
    }
    ...
    function Vu(n, t, e, r) {
        ...
        if (n.x = t += r * n.x, n.y = e += r * n.y, n.r *= r, u)
            for (var i = -1, o = u.length; ++i < o;) Vu(u[i], t, e, r)
    }
    ...
    function ii(n, t, e, r) {
        function u() {
            var u = Math.min(n.length, t.length) > 2 ? ui : ti,
                c = r ? eu : tu;
    ...
    function Ho(n, t, e) {
        ...
        return r.invert = function(t) {
            ...
            return a && (n = a[0], t = a[1]), r.domain(ei(i, t > 1 ? {
                floor: function(t) {
    ...
    Zo.touches = function(n, t) {
        ...
        function r(n, t, e, r) {
            return function() {
                ...
                function a() {
                    m.on(e + "." + p, null).on(r + "." + p, null), y(d && Zo.event.target === h), f({
                        type: "dragend"
                    })
                }
                var c, s = this,
                    ...
                    v = t(l, g),
                    d = 0,
                    m = Zo.select(Wo).on(e + "." + p, o).on(r + "." + p, a),
                    y = D();
        ...
        var u = g(n, "drag", "dragstart", "dragend"),
            i = null,
            o = r(c, Zo.mouse, "mousemove", "mouseup"),
    ...
    Zo.interpolateZoom = function(n, t) {
        ...
        function l() {
            ...
            var g, p = this,
                v = q.of(p, arguments),
                d = {}, m = 0,
                y = Zo.event.changedTouches[0].identifier,
                M = "touchmove.zoom-" + y,
                _ = "touchend.zoom-" + y,
                b = Zo.select(Wo).on(M, i).on(_, h),
                w = Zo.select(p).on(A, null).on(L, e),
                k = D();
            T.call(p), e(), o(v)
        }
    ...
    var Ja = ".",
        ...
        Ka = [3, 3],
        Qa = "$",
        nc = ["y", "z", "a", "f", "p", "n", "\xb5", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"].map(bt);
    ...
    var Jc = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g;
    Zo.interpolate = Tr, Zo.interpolators = [
        function(n, t) {
            var e = typeof t;
    ...
    Zo.interpolateTransform = nu, Zo.layout = {}, Zo.layout.bundle = function() {
        ...
        return a.tick = function() {
            ...
            if (g)
                for (lu(t = Zo.geom.quadtree(d), r, o), e = -1; ++e < _;)(a = d[e]).fixed || t.visit(n(a));
    ...
    Zo.layout.histogram = function() {
        ...
        var t, e = Zo.layout.hierarchy().sort(ju),
            r = 0,
            u = [1, 1];
    ...
    var ss = [2062260, 16744206, 2924588, 14034728, 9725885, 9197131, 14907330, 8355711, 12369186, 1556175].map(it),
        ls = [2062260, 11454440, 16744206, 16759672, 2924588, 10018698, 14034728, 16750742, 9725885, 12955861, 9197131, 12885140, 14907330, 16234194, 8355711, 13092807, 12369186, 14408589, 1556175, 10410725].map(it),
        fs = [3750777, 5395619, 7040719, 10264286, 6519097, 9216594, 11915115, 13556636, 9202993, 12426809, 15186514, 15190932, 8666169, 11356490, 14049643, 15177372, 8077683, 10834324, 13528509, 14589654].map(it),
        hs = [3244733, 7057110, 10406625, 13032431, 15095053, 16616764, 16625259, 16634018, 3253076, 7652470, 10607003, 13101504, 7695281, 10394312, 12369372, 14342891, 6513507, 9868950, 12434877, 14277081].map(it);
    Zo.scale.quantile = function() {
        ...
        function n() {
            var n = t.apply(this, arguments),
                ...
                o = r.apply(this, arguments) + gs,
                a = u.apply(this, arguments) + gs,
        ...
        return n.innerRadius = function(e) {
            ...
            var n = (t.apply(this, arguments) + e.apply(this, arguments)) / 2,
                i = (r.apply(this, arguments) + u.apply(this, arguments)) / 2 + gs;
        ...
        function n(n) {
            n.each(function() {
                var n, s = Zo.select(this),
                    ...
                    m = Zo.transition(p).style("opacity", 1),
                    y = ni(f),
    ...
    Zo.svg.brush = function() {
        ...
        function u() {
            ...
            function d() {
                var n = Zo.mouse(_),
                    u = !1;
                M && (n[0] += M[0], n[1] += M[1]), C || (Zo.event.altKey ? (x || (x = [(l[0] + l[1]) / 2, (h[0] + h[1]) / 2]), L[0] = l[+(n[0] < x[0])], L[1] = h[+(n[1] < x[1])]) : x = null), E && m(n, c, 0) && (e(S), u = !0), A && m(n, s, 1) && (r(S), u = !0), u && (t(S), w({
                    type: "brush",
                    mode: C ? "move" : "resize"
                }))
            }
            ...
            function y() {
                d(), S.style("pointer-events", "all").selectAll(".resize").style("display", n.empty() ? "none" : null), Zo.select("body").style("cursor", null), T.on("mousemove.brush", null).on("mouseup.brush", null).on("touchmove.brush", null).on("touchend.brush", null).on("keydown.brush", null).on("keyup.brush", null), N(), w({
                    type: "brushend"
                })
            }
            var x, M, _ = this,
                ...
                N = D(),
                L = Zo.mouse(_),
                T = Zo.select(Wo).on("keydown.brush", u).on("keyup.brush", g);
            if (Zo.event.changedTouches ? T.on("touchmove.brush", d).on("touchend.brush", y) : T.on("mousemove.brush", d).on("mouseup.brush", y), S.interrupt().selectAll("*").interrupt(), C) L[0] = l[0] - L[0], L[1] = h[0] - L[1];
            else if (k) {
                var q = +/w$/.test(k),
                    z = +/^n/.test(k);
    ...
    var zs = Date.prototype,
        Rs = "%a %b %e %X %Y",
        Ds = "%m/%d/%Y",
        Ps = "%H:%M:%S",
        Us = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"],
        js = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"],
        Hs = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"],
        Fs = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];
    ...
    var el = [1e3, 5e3, 15e3, 3e4, 6e4, 3e5, 9e5, 18e5, 36e5, 108e5, 216e5, 432e5, 864e5, 1728e5, 6048e5, 2592e6, 7776e6, 31536e6],
        rl = [
            [Ls.second, 1],
            [Ls.second, 5],
            [Ls.second, 15],
